...
Partial Public Class ManitariaAlexandroupolisWindowsFormsApplication
    ...
    End Sub
    Private Sub ManitariaAlexandroupolisWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
        e.Updater.Update()
        e.Handled = True
#Else
...
#End If
    End Sub
    Private Shared Sub ManitariaAlexandroupolisWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs)
