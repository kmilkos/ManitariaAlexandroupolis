...
Imports ManitariaAlexandroupolis
...
#End If
        ...
        Dim _application As ManitariaAlexandroupolisWindowsFormsApplication = New ManitariaAlexandroupolisWindowsFormsApplication()
