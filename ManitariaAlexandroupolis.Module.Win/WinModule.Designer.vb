...
Partial Public Class ManitariaAlexandroupolisWindowsFormsModule
    ''' <summary> 
...
#Region "Component Designer generated code"
    ...
    Private Sub InitializeComponent()
        '
        'EvritikaManitariaWindowsFormsModule
        '
        Me.RequiredModuleTypes.Add(GetType(ManitariaAlexandroupolis.[Module].ManitariaAlexandroupolisModule))
